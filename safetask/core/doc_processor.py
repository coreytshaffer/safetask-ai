...
def append_to_database(code, title, raw_text, keywords):
    raise ValueError("Direct policy publication is disabled; uploads cannot create reviewed authority")


def process_upload(file_path, code, title):
    raise ValueError("Direct policy publication is disabled; no file was processed")
